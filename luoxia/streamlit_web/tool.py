...
def base_page_config(st):
    ...
    if "video_subject" not in st.session_state:
        st.session_state["video_subject"] = "马来西亚"
...
i18n_dir = ROOT_DIR.joinpath('streamlit_web', 'i18')
...
def left_panel_settings(st, params):
...
def middle_panel_settings(st, params):
...
def right_panel_settings(st, params):
    with st.container(border=True):
