...
_enable_redis = CONF.default.get("enable_redis", False)
_redis_host = CONF.default.get("redis_host", "localhost")
_redis_port = CONF.default.get("redis_port", 6379)
_redis_db = CONF.default.get("redis_db", 0)
_redis_password = CONF.default.get("redis_password", None)
_max_concurrent_tasks = CONF.default.get("max_concurrent_tasks", 5)
...
def get_task(
    ...
    endpoint = CONF.default.get("endpoint", "")
    if not endpoint:
